              ...
              <div className="form-card">
                ...
                <div className="form-innercontent">
                  <div className="sell-list">
                    ...
                    <div className="sell-input">
                      <img style={{width: '500px'}} alt="품목 사진" src={data.file_name ? "http://211.62.225.216:4000/static/" + data.file_name : '318x180.svg'} />
                    </div>
                  </div>
                  <div className="sell-list">
                    ...
                    <div className="sell-input">
											{this.state.data.detail_file.map((e, i) => {
												return <img style={{width: '500px'}} key={i} alt="품목 사진" src={"http://211.62.225.216:4000/static/" + e} />
											})}
                    </div>
                  </div>
                </div>
