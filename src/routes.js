...
const routes = [
  ...
  { path: '/home', name: '홈', component: Home},
  ...
  { path: '/stock/edit', exact: true,  name: '재고 관리', component: EditStock},
  { path: '/sales/order/:id', exact: true,  name: '주문 상세', component: OrderDetail},
